...
(* Função que formata lista de caracteres e gera uma lista de strings com as informações dos blocos *)
...
if i < tam then
	...
	then formata(tam, chlist,i+1,stlist) (* chama função de novo*)
	...
	else formata(tam, recebechar(List.nth (listaCaracteres, i),chlist), i+1,stlist) (* chama função q guarda palavra *)
else stlist;
